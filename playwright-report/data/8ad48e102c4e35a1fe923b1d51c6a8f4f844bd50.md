...
- Name: pages.spec.ts >> Contact Page >> shows validation error for short message
- Location: __tests__\e2e\pages.spec.ts:37:7
...
- main:
  ...
  - combobox "Area of Interest":
    ...
    - option "Media"
  - text: Message * 5 / 1000
  - textbox "Message *" [invalid]:
    - /placeholder: Tell us about your mission, project or interest.
    - text: Short
  - paragraph: Tell us a little more (min. 10 characters).
...
- contentinfo:
  ...
  - paragraph: UTC 11:27:34 · 24.71°N 46.68°E
