...
Call log:
  ...
  - retrying click action
    ...
    2 × waiting for element to be visible, enabled and stable
      ...
      - scrolling into view if needed
      - done scrolling
      - <p class="font-mono text-[11px] uppercase tracking-[0.35em] text-mist">…</p> from <div id="preloader" aria-hidden="true" class="fixed inset-0 z-[95] flex flex-col items-center justify-center bg-void ">…</div> subtree intercepts pointer events
    - retrying click action
      - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
  ...
  - contentinfo [ref=e123]:
    - generic [ref=e125]:
      ...
      - generic [ref=e186]:
        ...
        - paragraph [ref=e188]: UTC 12:21:21 · 24.71°N 46.68°E
